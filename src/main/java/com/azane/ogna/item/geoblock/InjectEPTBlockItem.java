...
public class InjectEPTBlockItem extends BlockItem implements GeoItem
{
    ...
    {
        pTooltip.add(Component.translatable("block.ognmarts.inject_ept.desp").withStyle(ChatFormatting.DARK_GRAY,ChatFormatting.ITALIC));
    }
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if(this.renderer == null) {
                    ...
                    this.renderer.addRenderLayer(new GlowingLayer<>(this.renderer));
                }
