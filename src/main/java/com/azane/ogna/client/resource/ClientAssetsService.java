...
public enum ClientAssetsService
{
    ...
    public void reloadAndRegister(Consumer<PreparableReloadListener> register)
    {
        if (listeners == null)
        {
            ...
            modelAddition = register(new NamelyDataManager<>(ModelAdditionManager.class, IResourceProvider.GSON,"ogna/config","model_addition",rl->rl.getPath().equals("model_addition"),true));
        }
